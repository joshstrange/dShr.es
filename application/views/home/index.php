            ...
            function getLink(path,icon,size,pos)
            {
				...
				$.getJSON('/getDSLink?path='+path+'&icon='+icon+'&size='+size, function(data) {
					if(!data.error)
					{
						...
						var twitterLink = '<a href="https://twitter.com/share" class="twitter-share-button" data-url="'+data.url+'" data-text="'+fileName+'" data-via="dShresApp" data-count="none">Tweet</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>';
